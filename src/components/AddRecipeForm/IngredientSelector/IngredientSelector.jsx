...
import styles from "./StIngredientSelector.module.css";
...
const StIngredientSelector = ({
  ...
  const st_removeIngredient = (index) => {
  ...
  const st_renderLoader = (isLoading) => {
    ...
    <div className={styles.container}>
      ...
      <div className={styles.selectors_time_wrapp}>
        <div className={styles.categoryAndTime}>
          {st_renderLoader(isCategoriesLoading) || (
            <div>
        ...
        <div>
          <StCookingTimeCounter cookingTime={cookingTime} setCookingTime={setCookingTime} />
          {errors.cookingTime && <p className={styles.errorMsg}>{errors.cookingTime.message}</p>}
        </div>
      </div>
      <div className={styles.categoryAndTime}>
        {st_renderLoader(isAreasLoading) || (
          <div>
            <label>Area</label>
            <SelectShared
              options={areas}
          ...
          {selectedIngredients.map((ingredient, index) => (
            <li key={index} className={styles.listItem}>
              ...
              <StIconButton
                ...
                type="button"
                onClick={() => st_removeIngredient(index)}
...
export default StIngredientSelector;
