...
import { StAddMoreButton } from "src/components/StRecipe/StRecipeNavigation/StAddMoreButton/StAddMoreButton";
import { StNavigationButton } from "src/components/StRecipe/StRecipeNavigation/StNavigationButton/StNavigationButton";
...
export const StRecipeNavigation = () => {
    ...
    <nav>
      <ul className={cx(styles["navigation"])}>
        ...
        {numberNavElements < CATEGORIES.length && (
          <li>
            <StAddMoreButton onClick={st_handlerAddMoreBtn} />
          </li>
        )}
      </ul>
    </nav>
